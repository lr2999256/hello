...
<body>
<form action="<c:url value='/user/deleteres'/>" method="post">
    ...
    <table align="center" align="center" width="30%" cellpadding="0" cellspacing="0" style="height: 20px; font-size: 14px;">
        ...
        <tr style="height: 20px;font-size: 14px;">
            ...
            <td align="left" style="border:1px solid black;font-size: 14px;"><input type="password" name="passWd" value="${user.usrNm}"/></td>
        </tr>
